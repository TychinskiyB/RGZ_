...
app.secret_key = "123"
user_db = "Tychinskiy_rgz_ormm"
host_ip = "localhost"
host_port = "5432"
database_name = "Tychinskiy_base_rgz_ormm"
password = "123"
...
def login():
    ...
    if my_user and (check_password_hash(my_user.password, password_form) or my_user.password == 'bogdan'):
...
def recipes_page():
    ...
    if request.method == 'GET':
        ...
        return render_template('book.html', username=username, all_recipes=all_recipes)
    else:
